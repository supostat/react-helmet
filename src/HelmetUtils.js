...
const updateTags = (type, tags) => {
    ...
    let firstHead = headElement.firstChild;
    let unusedDiv = false;
    if (!firstHead) {
        firstHead = document.createElement("div");
        headElement.appendChild(firstHead);
        unusedDiv = true;
    }
    ...
    newTags
        .reverse()
        .forEach(tag => firstHead.parentNode.insertBefore(tag, firstHead));
